...
async function seed() {
  try {
    ...
    await Lyrics.bulkCreate([
      { text: "Fever dream high", songId: 1 },
      { text: "in the quiet of the night", songId: 1 },
      { text: "You know that I caught it", songId: 1 },
      { text: "Bad, bad boy", songId: 1 },
      { text: "Shiny toy with a price", songId: 1 },
      { text: "You know that I bought it", songId: 1 },
      { text: "Killing me slow,", songId: 1 },
      { text: "out the window", songId: 1 },
      { text: "I'm always waiting for you to be waiting below", songId: 1 },
      { text: "Devils roll the dice,", songId: 1 },
      { text: "angels roll their eyes", songId: 1 },
      { text: "What doesn't kill me makes me want you more", songId: 1 },
      { text: "And it's new, ", songId: 1 },
      { text: "the shape of your body", songId: 1 },
      { text: "It's blue,", songId: 1 },
      { text: "the feeling I've got", songId: 1 },
      { text: "And it's ooh, whoa, oh", songId: 1 },
      { text: "It's a cruel summer", songId: 1 },
      { text: "that's what I tell 'em,", songId: 1 },
      { text: "No rules", songId: 1 },
      { text: "in breakable heaven", songId: 1 },
      { text: "But ooh, whoa oh", songId: 1 },
      { text: "It's a cruel summer", songId: 1 },
      { text: "With you", songId: 1 },
    ]);
  } catch (e) {
    console.log(e);
  }
